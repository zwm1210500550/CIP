    ...
    def get_score(self, f,offset):
        ...
        for i in f:
            if i in self.feature:
                if self.feature[i]+offset==1922372:
                    pass
                ...
                for index_word in range(0, len(self.words[index_sen])):
                    ...
                    if max_tag != right_tag:
                        ...
                        for i in f_right_tag:
                            if i in self.feature:
                                self.weight[self.feature[i]+self.len_feature*self.dic_tags[right_tag]] += 1
                        for i in f_max_tag:
                            if i in self.feature:
                                self.weight[self.feature[i]+self.len_feature*self.dic_tags[max_tag]] -= 1
